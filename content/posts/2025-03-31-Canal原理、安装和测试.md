---
title: "Canal 原理、安装与测试"
date: 2025-03-31 08:00:00+08:00
slug: canal-install-test
categories: [ "tech" ]
tags: [ "database" ]
description: "介绍 Canal 的工作原理、安装步骤与基础测试方式，帮助快速理解它在 MySQL Binlog 增量同步场景中的用法。"
---
...
![img](canal-install-test/01.webp)
...
```yaml
  zhijunio-canal-server:
    image: canal/canal-server
    container_name: zhijunio-canal-server
    ports:
      - "11111:11111"
    environment:
      - canal.auto.scan=false
      - canal.instance.mysql.slaveId=123
      - canal.instance.master.address=zhijunio-mysql:3306
...
```yaml
  zhijunio-canal-admin:
    image: canal/canal-admin
    container_name: zhijunio-canal-admin
    ports:
      - "8089:8089"
    environment:
      - canal.adminUser=admin
      - canal.adminPasswd=123456
      - spring.datasource.url=jdbc:mysql://zhijunio-mysql:3306/canal_manager?autoReconnect=true&useUnicode=true
...
![img](canal-install-test/02.webp)
