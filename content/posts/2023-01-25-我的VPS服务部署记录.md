...
export GIT_EMAIL=zhijun.lab@gmail.com
...
MIRROR=aws-bos CREATE_USER=zhijunio DOMAIN=zhijun.io CF_Token=xxx CF_Account_ID=xxx bash almalinux9-setup.sh
```
